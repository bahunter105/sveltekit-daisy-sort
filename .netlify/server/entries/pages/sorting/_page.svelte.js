...
<div class="${"container mx-auto flex justify-center"}"><button class="${"btn btn-wide btn-success m-4 p-2 shadow-md"}">Run Sorting Algorithm</button></div>


<div class="${"container mx-auto flex justify-center"}">${each(entity_array, (entity) => {
    return `${validate_component(Card, "Card").$$render(
      $$result,
      {
        type: "entity",
